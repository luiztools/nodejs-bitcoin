...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Qual a criptomoeda que você deseja a cotação?';
...
const GetCryptoIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'GetCryptoIntent';
    },
    handle(handlerInput) {
        ...
        return axios.get(`https://api.binance.com/api/v3/avgPrice?symbol=${crypto.toUpperCase()}USDT`)
            .then(response => {
